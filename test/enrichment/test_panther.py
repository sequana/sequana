...
def test_panther1(mocker, tmpdir):
    ...
    pe.plot_go_terms("up", ontologies="MF", compute_levels=False)
    pe.plot_go_terms("up", ontologies="MF", compute_levels=False, log=True, include_negative_enrichment=True)

    df, subdf = pe._get_plot_go_terms_data("up", ontologies="MF", compute_levels=False)
