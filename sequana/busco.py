...
class BuscoConfig(object):
    def __init__(
        self, species, outpath=None, sample_name=None, conda_bin_path=None, tmp_path=None, Rscript_bin_path=None
    ):
...
class BuscoAnalysis(object):
    def __init__(self, bin_path=None, config_path=None, species=None, sample_name=None, outpath=None):
        """
    ...
    def multirun(self, infile, threads=4, mode="genome", species=[]):
        ...
        for this in species:
            ...
            try:
                ...
                ab = BUSCO("{}/run_{}/full_table_{}.tsv".format(self.outpath, self.sample_name, self.sample_name))
                res[this] = ab.score
            except:
                pass
