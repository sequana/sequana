...
Issues: http://github.com/sequana/sequana
        ...
        """
        super(Options, self).__init__(usage=usage, prog=prog, description=description)

        # options to fill the config file
        self.add_argument("--file1", dest="file1", type=str, help="""R1 fastq file (zipped) """)
        self.add_argument("--file2", dest="file2", type=str, help="""R2 fastq file (zipped) """)
        self.add_argument(
            "--databases",
            dest="databases",
            type=str,
        ...
        self.add_argument(
            "--thread", dest="thread", type=int, help="""number of threads to use (default 4)""", default=4
        )
        self.add_argument(
            "--show-html",
            dest="html",
        ...
        self.add_argument("--unclassified-out", help="save unclassified sequences to filename")
        self.add_argument("--classified-out", help="save classified sequences to filename")
        self.add_argument("--confidence", type=float, default=0, help="confidence (kraken2 DB only)")
        self.add_argument(
            "--update-taxonomy",
            action="store_true",
            default="False",
        ...
        self.add_argument(
            "--level", dest="level", default="INFO", choices=["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"]
        )
